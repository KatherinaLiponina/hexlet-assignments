...
class ValidationTest {
    ...
    //     Address address2 = new Address("USA", "London", "1-st street", "5", "1");
    //     Map<String, String> mappa = Map.of("MinLength", "city");
    //     assertThat(Validator.validate(address2)).isEqualTo(mappa);
    // }
    // END
}
